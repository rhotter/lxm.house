...
**Feb 6, 2025: Math and Physics Night**
- Vivek: PSI From Lightweight OPRF
- Marley: Shear wave attenuation in tissue
- Group: Why cross products only exist in 3 and 7 dimensions

**Feb 2, 2025: Demo Night**
- Leila - Tracking the lobster truck
- Katie - Improving NYT connections and p5.js
- Gavriel - Choosing a sword
- Clovis - LLMs asking about geospatial data
- Aayush - whatdidyoudo.dev
- Vincent - How to use polynomials
- Robert - tl;dr of biblical history
- Nate - Land map of the USA and the mysterious checkerboard
- Thomas - Live demo of ultrasound blood flow detection
- Kelsey - Vision zero analysis
- Raffi - Why neurons fire slowly
...
- Aayush - [zinenight](/zinenight), second lxm zine night site built by Alicia
